	...
	<body class="home layout2">
								...
								<li>
									<div class="head-info">
										<span class="hd_is map">
											<svg version="1.1" id="Capa_146" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
								...
								<li>
									<div class="head-info">
										<span class="hd_is time">
											<svg version="1.1" id="Capa_134" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
				...
				<ul class="hd_opts">
					<li class="active">
						<a href="#" title="" class="apt_form_btn"><span>Appointment</span>
							<span class="apt-icon">
								<svg version="1.1" id="Capa_135" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
					...
					<li>
						<a href="#" title="" class="direction_map_btn"><span>Get Directions</span>
							<span class="apt-icon">
								<svg version="1.1" id="Capa_367" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="22px" viewBox="0 0 97.713 97.713" xml:space="preserve">
									<g>
										<path d="M48.855,0C29.021,0,12.883,16.138,12.883,35.974c0,5.174,1.059,10.114,3.146,14.684
											c8.994,19.681,26.238,40.46,31.31,46.359c0.38,0.441,0.934,0.695,1.517,0.695s1.137-0.254,1.517-0.695
											c5.07-5.898,22.314-26.676,31.311-46.359c2.088-4.57,3.146-9.51,3.146-14.684C84.828,16.138,68.69,0,48.855,0z M48.855,54.659
				...
				<div class="container">
					...
					<div class="apt_btn">
						<a href="#" title="" class="appointment_btn apt_form_btn"> Appointment
							<span class="apt-icon">
								<svg version="1.1" id="Capa_136" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="488.152px" height="488.152px" viewBox="0 0 488.152 488.152" xml:space="preserve">
								<g>
									<g>
										<path d="M177.854,269.311c0-6.115-4.96-11.069-11.08-11.069h-38.665c-6.113,0-11.074,4.954-11.074,11.069v38.66
				...
				<div class="container">
					...
					<div class="apt_btn">
						<a href="#" title="" class="appointment_btn apt_form_btn">
							<span class="apt-icon">
								<svg version="1.1" id="Capa_137" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="488.152px" height="488.152px" viewBox="0 0 488.152 488.152" xml:space="preserve">
								<g>
									<g>
										<path d="M177.854,269.311c0-6.115-4.96-11.069-11.08-11.069h-38.665c-6.113,0-11.074,4.954-11.074,11.069v38.66
											c0,6.123,4.961,11.079,11.074,11.079h38.665c6.12,0,11.08-4.956,11.08-11.079V269.311L177.854,269.311z"></path>
					...
					<div class="search_icon">
						<svg version="1.1" id="Capa_423" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
				...
				<div class="container">
					<nav>
						<ul>
							...
							<li><a class="active" href="services_page.html" title="">Services</a>
								<ul>
					...
					<div class="search_icon">
						<svg version="1.1" id="Capa_41" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
							 width="28.931px" height="28.932px" viewBox="0 0 28.931 28.932" xml:space="preserve">
						<g>
							<path d="M28.344,25.518l-6.114-6.115c1.486-2.067,2.303-4.537,2.303-7.137c0-3.275-1.275-6.355-3.594-8.672
								C18.625,1.278,15.543,0,12.266,0C8.99,0,5.909,1.275,3.593,3.594C1.277,5.909,0.001,8.99,0.001,12.266
		...
		<div class="responsive-menu">
			...
			<ul>
				<li><a href="index.html" title="">HOME</a></li>
				<li><a href="about_page.html" title="">About us</a></li>
				<li><a class="active" href="#" title="">Services</a>
					<ul>
						<li><a class="active" href="services_page.html" title="">Services</a></li>
			...
			<section class="block tp-100 service-page">
				<div class="container">
					<div class="sec-title">
						...
						<p>We offer a variety of cooling and heating services for both residential and commercial properties, including upgrades, repairs, replacements, and installations</p>
					</div><!--sec-title end-->
					<div class="servies_page">
								...
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="servies_details">
										<div class="servies_img">
											<img src="images/resources/sv1.jpg" alt="">
										</div>
										<h2><a href="services_single.html" title="">Air Conditioning</a></h2>
										<p>Your comfort needs are of top priority and that everyone’s essentials are different, which is why we’ve got you covered. </p>
									</div><!--servies_details end-->
								</div>
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="servies_details">
										<div class="servies_img">
											<img src="images/resources/sv2.jpg" alt="">
										</div>
										<h2><a href="services_single.html" title="">Air Conditioner Repair</a></h2>
										<p>After years of performance, it can break down and you may need air conditioning system repair. </p>
									</div><!--servies_details end-->
								</div>
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="servies_details">
										<div class="servies_img">
											<img src="images/resources/sv3.jpg" alt="">
										</div>
										<h2><a href="services_single.html" title="">Duct Services</a></h2>
										<p>Clean air ducts improve the quality of the air in your home, which is important if you have allergies or asthma.</p>
									</div><!--servies_details end-->
								</div>
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="servies_details">
										<div class="servies_img">
											<img src="images/resources/sv4.jpg" alt="">
										</div>
										<h2><a href="services_single.html" title="">Thermostats Installation</a></h2>
										<p>Thermostat learn what temperatures you like and program themselves to adjust the temperature just for you.  </p>
									</div><!--servies_details end-->
								</div>
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="servies_details">
										<div class="servies_img">
											<img src="images/resources/sv5.jpg" alt="">
										</div>
										<h2><a href="services_single.html" title="">Maintenance</a></h2>
										<p>Like any major appliance, your air conditioner works best with regular care and maintenance.  </p>
									</div><!--servies_details end-->
								</div>
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="servies_details">
										<div class="servies_img">
											<img src="images/resources/sv6.jpg" alt="">
										</div>
										<h2><a href="services_single.html" title="">24/7 Emergency</a></h2>
										<p>We also provide emergency service for those days when you need it most!</p>
									</div><!--servies_details end-->
								</div>
							</div>
						</div><!--servies_row end-->
						<div class="servies_row" id="heating-services">
							<div class="row">
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="servies_details">
										<div class="servies_img">
											<img src="images/resources/svs1.jpg" alt="">
										</div>
										<h2><a href="services_single.html" title="">Heating Installation</a></h2>
										<p>Your comfort needs are of top priority and that everyone’s essentials are different, which is why we’ve got you covered. </p>
									</div><!--servies_details end-->
								</div>
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="servies_details">
										<div class="servies_img">
											<img src="images/resources/svs2.jpg" alt="">
										</div>
										<h2><a href="services_single.html" title="">Heating Repair</a></h2>
										<p>After years of performance, it can break down and you may need air conditioning system repair. </p>
									</div><!--servies_details end-->
								</div>
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="servies_details">
										<div class="servies_img">
											<img src="images/resources/svs3.jpg" alt="">
										</div>
										<h2><a href="services_single.html" title="">Heating furnaces</a></h2>
										<p>Clean air ducts improve the quality of the air in your home, which is important if you have allergies or asthma.</p>
									</div><!--servies_details end-->
								</div>
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="servies_details">
										<div class="servies_img">
											<img src="images/resources/svs4.jpg" alt="">
										</div>
										<h2><a href="services_single.html" title="">Heating Pumps</a></h2>
										<p>Thermostat learn what temperatures you like and program themselves to adjust the temperature just for you.  </p>
									</div><!--servies_details end-->
								</div>
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="servies_details">
										<div class="servies_img">
											<img src="images/resources/svs5.jpg" alt="">
										</div>
										<h2><a href="services_single.html" title="">Ductwork Installation</a></h2>
										<p>Like any major appliance, your air conditioner works best with regular care and maintenance.  </p>
									</div><!--servies_details end-->
								</div>
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 full_wdth">
									<div class="servies_details">
										...
										<h2><a href="services_single.html" title="">Heating Fizz</a></h2>
										<p>We also provide emergency service for those days when you need it most!</p>
									</div><!--servies_details end-->
								</div>
							</div>
						...
						<div class="load-more">
							<a href="#" title="" class="lnk_default apt_form_btn">Schedule for Service</a>
						</div>
			...
			<section class="block p-100">
				...
				<div class="container">
					<div class="sep-text fl-right">
						...
						<span><i class="fa fa-phone"></i> 609-123-4567</span>
					</div><!--sep-text end-->
				</div>
			</section>
		...
		<div class="appointment_form">
			...
			<form class="rqs_form" id="contactform-modal" method="post" novalidate>
				<div class="input_field">
					<input type="text" name="name" placeholder="Your name">
				</div><!--input_field end-->
				<div class="input_field">
