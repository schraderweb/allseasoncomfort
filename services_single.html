	...
	<header>
							...
							<li>
								<div class="head-info">
									<span class="hd_is map">
										<svg version="1.1" id="Capa_13455" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			...
			<ul class="hd_opts">
				...
				<li>
					<a href="#" title="" class="direction_map_btn"><span>Get Directions</span>
						<span class="apt-icon">
							<svg version="1.1" id="Capa_323" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="22px" viewBox="0 0 97.713 97.713" xml:space="preserve">
								<g>
									<path d="M48.855,0C29.021,0,12.883,16.138,12.883,35.974c0,5.174,1.059,10.114,3.146,14.684
										c8.994,19.681,26.238,40.46,31.31,46.359c0.38,0.441,0.934,0.695,1.517,0.695s1.137-0.254,1.517-0.695
										c5.07-5.898,22.314-26.676,31.311-46.359c2.088-4.57,3.146-9.51,3.146-14.684C84.828,16.138,68.69,0,48.855,0z M48.855,54.659
			...
			<div class="container">
				...
				<div class="apt_btn">
					<a href="#" title="" class="appointment_btn apt_form_btn"> Appointment
						<span class="apt-icon">
							<svg version="1.1" id="Capa_134" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="488.152px" height="488.152px" viewBox="0 0 488.152 488.152" xml:space="preserve">
							<g>
								<g>
									<path d="M177.854,269.311c0-6.115-4.96-11.069-11.08-11.069h-38.665c-6.113,0-11.074,4.954-11.074,11.069v38.66
			...
			<div class="container">
				...
				<div class="apt_btn">
					<a href="#" title="" class="appointment_btn apt_form_btn">
						<span class="apt-icon">
							<svg version="1.1" id="Capa_13554" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="488.152px" height="488.152px" viewBox="0 0 488.152 488.152" xml:space="preserve">
							<g>
								<g>
									<path d="M177.854,269.311c0-6.115-4.96-11.069-11.08-11.069h-38.665c-6.113,0-11.074,4.954-11.074,11.069v38.66
										c0,6.123,4.961,11.079,11.074,11.079h38.665c6.12,0,11.08-4.956,11.08-11.079V269.311L177.854,269.311z"></path>
				...
				<div class="search_icon">
					<svg version="1.1" id="Capa_46" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
		...
		<div class="navigations">
			<div class="container">
				...
				<div class="search_icon">
					<svg version="1.1" id="Capa_45" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
						 width="28.931px" height="28.932px" viewBox="0 0 28.931 28.932" xml:space="preserve">
					<g>
						<path d="M28.344,25.518l-6.114-6.115c1.486-2.067,2.303-4.537,2.303-7.137c0-3.275-1.275-6.355-3.594-8.672
							C18.625,1.278,15.543,0,12.266,0C8.99,0,5.909,1.275,3.593,3.594C1.277,5.909,0.001,8.99,0.001,12.266
		...
		<ul>
			...
			<li><a class="active" href="#" title="">Services</a>
				<ul>
					...
					<li><a class="active" href="services_single.html" title="">Services Single</a></li>
				</ul>
			</li>
			<li><a href="price_page.html" title="">Prices</a></li>
			<li><a href="gallery_page.html" title="">Gallery</a></li>
						...
						<div class="col-lg-9 col-md-9 pull-right">
							<div class="service-single-details">
								<div class="service-single">
									...
									<img src="images/resources/service-img.jpg" alt="">
									<h3>High Efficient Ac Installation, A/c Installation & Air Conditioning Installation</h3>
									<p>Central air conditioning allows you to enjoy the perfect temperature in any room of your house. Bedrooms can be kept refreshingly cool even on the stickiest summer nights. You’ll benefit from ideal sleeping conditions, complete humidity control, and a fresher, cleaner home. Through effective, air-purifying filtration systems, cooling units also reduce bacteria, dust, house mites, mold, pet dander and pollen, proving extremely beneficial for those who suffer from allergies and respiratory problems. </p>
									<p> When you’re ready to experience your summer in a whole new way, call Heating & Cooling for air conditioning installation, and we’ll exceed your expectations.</p>
									<h3>Expert AC Replacement</h3>
									<p>At Heating & Cooling we are committed to doing the job right. As a Factory Authorized Dealer, our technicians are NATE-certified professionals who have completed a demanding set of core and specialty exams to ensure their technical competency. They also continue training specific to Carrier technology and products. We are fully bonded and insured, offer free in-home estimates and convenient financing options.  As family owned and operated business since 2010, we’ve served the comfort needs of Pittsburgh and the surrounding areas with a dedication to providing the best prices for the very best service.</p>
									<p> When it comes to managing indoor humidity, the two-stage compressor makes a significant comfort difference, allowing the system to function mostly in low-stage, where you achieve the highest efficiency.  A filter drier system protects against moisture and contaminants while compressor sound blanket keeps operational noise down to 65 decibels.</p>
									<h3>Top Quality Air Conditioning Installation</h3>
									<p>By installing an air conditioning system that has met the standards set by the Environmental Protection Agency, you stand to save 30% on cooling bills each year. </p>
									<p>The factory-trained technicians from Heating & Cooling have the experience, product knowledge and commitment to design a system to perfectly match your expectations for efficiency, performance and budget. Through skilled and meticulous installation, our team will get the most out of your energy dollar, allowing you to maintain luxurious indoor temperatures without suffering the consequences of high utility bills.  We not only take pride in completing your project quickly, neatly and perfectly, we’re available for seasonal maintenance to keep your system operating at peak capacity. </p>
								</div><!--service-single end-->
								<div class="service-svv">
									<div class="svv-img">
										<img src="images/resources/vc.png" alt="">
									</div>
									<div class="svv-info">
										<h3>Peace of mind for you and your family.</h3>
										<p>Cooling & Heating has been repairing AC systems for more than 10 years. We want you to be cool and comfortable, and we’ll guarantee any repairs we make through a one-year warranty.</p>
									</div><!--svv-info end-->
								</div><!--service-svv end-->
							</div>
						</div>
								...
								<div class="contact_wd">
									...
									<ul>
										<li>
											...
											<h4>1531 Moonlight Drive, Maple Shade, NJ</h4>
										</li>
										<li>
											<span><i class="fa fa-clock-o"></i></span>
											<h4>Monday-Friday <br /> 8:00 am - 8:00 pm</h4>
										</li>
										<li>
											<span><i class="fa fa-phone"></i></span>
											<h4>24/7 Emergency Service: 609-123-4567</h4>
										</li>
									</ul>
								</div><!--contact_wd end-->
								<div class="ht_form">
