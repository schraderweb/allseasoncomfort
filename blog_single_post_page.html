			...
			<ul class="hd_opts">
				...
				<li>
					<a href="#" title="" class="direction_map_btn"><span>Get Directions</span>
						<span class="apt-icon">
							<svg version="1.1" id="Capa_3269" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="22px" viewBox="0 0 97.713 97.713" xml:space="preserve">
								<g>
									<path d="M48.855,0C29.021,0,12.883,16.138,12.883,35.974c0,5.174,1.059,10.114,3.146,14.684
										c8.994,19.681,26.238,40.46,31.31,46.359c0.38,0.441,0.934,0.695,1.517,0.695s1.137-0.254,1.517-0.695
										c5.07-5.898,22.314-26.676,31.311-46.359c2.088-4.57,3.146-9.51,3.146-14.684C84.828,16.138,68.69,0,48.855,0z M48.855,54.659
			...
			<div class="container">
				<nav>
					<ul>
						...
						<li><a class="active" href="blog_posts_page.html" title="">blog</a>
							<ul>
		...
		<ul>
			...
			<li><a class="active" href="#" title="">blog</a>
				<ul>
					...
					<li><a class="active" href="blog_single_post_page.html" title="">Blog Single</a></li>
				</ul>
			</li>
			<li><a href="faqs_page.html" title="">faqs</a></li>
			<li><a href="contact_page.html" title="">contact us</a></li>
					...
					<div class="col-lg-9">
						<div class="blog_posts">
							<div class="blog-post s_ingle">
								<div class="blog-img">
									<img src="images/resources/blog-single-img.jpg" alt="">
								</div>
								<div class="blog-info">
									<ul class="meta">
										<li>
											<span>Posted by:</span> <a href="#" title="" class="admin">Admin</a>
										</li>
										<li><a href="#" title="">0 Comments</a></li>
									</ul><!--meta end-->
									<div class="blog_dv">
										<span class="posted_date"> 19 <b>Sep</b> </span>
										<div class="blog_ttl">
											<h2 class="post-title">Whole Home Humidifier Maintenance Checklist </h2>
										</div>
									</div>
									...
									<img src="images/resources/blg-img.jpg" alt="">
									...
									<p> Many homeowners rely on portable humidifiers to add moisture to the air in certain areas throughout the home. These types of humidifiers require more  </p>
									...
									<ul class="tagz-list">
										...
										<li><a href="#" title="">HVAC</a></li>
										<li><a href="#" title="">Split Systems</a></li>
									</ul>
									<div class="clearfix"></div>
								</div><!--blog-info end-->
							</div>
								...
								<li>
									<div class="coment">
										...
										<div class="coment-info">
											<h5>Posted by: <a href="#" title="">Jorge Moon</a></h5>
											<span class="postedd_date">19 September, 2019</span>
											<p>When you need individualized help for your home’s equipment, use our HVAC Contractor Directory to locate a nearby HVAC company to assist.</p>
											<a href="#" title="" class="reply_btn"><i class="fa fa-play"></i>Reply</a>
										</div>
									</div>
									<ul>
										<li>
											<div class="coment">
												...
												<div class="coment-info">
													<h5>Posted by: <a href="#" title="">Jorge Moon</a></h5>
													<span class="postedd_date">19 September, 2019</span>
													<p>Heating & Cooling is the leading resource for all things heating, cooling, and indoor air quality online. We offer a variety of free resources to help you understand and best care for your HVAC systems and components. </p>
													<a href="#" title="" class="reply_btn"><i class="fa fa-play"></i>Reply</a>
												</div>
											</div>
										</li>
					...
					<div class="col-lg-3">
						<div class="sidebar">
							...
							<div class="widget widget-categories">
								...
								<ul class="wegts-links">
									<li><a href="#" title="">Quality Products</a></li>
									<li><a href="#" title="">Quality Energy Evaluations</a></li>
									<li><a href="#" title="">Quality technicians</a></li>
									<li><a href="#" title="">Quality Installations</a></li>
									<li><a href="#" title="">Quality Service & Repairs</a></li>
								</ul>
									...
									<li>
										<div class="recent-post">
											<div class="recent-post-img">
												<img src="images/resources/rp-img1.png" alt="">
											</div>
											<div class="recent-post-info">
												<span>19 September</span>
												<h3 class="post_title"><a href="blog_single_post_page.html" title="">Need a New Heater? Choose a Heat Pump!</a></h3>
											</div>
										</div><!--recent-post end-->
									</li>
									<li>
										<div class="recent-post">
											<div class="recent-post-img">
												<img src="images/resources/rp-img2.png" alt="">
											</div>
											<div class="recent-post-info">
												<span>23 September</span>
												<h3 class="post_title"><a href="blog_single_post_page.html" title="">Changing Your Air Filters</a></h3>
											</div>
										</div><!--recent-post end-->
									</li>
									<li>
										<div class="recent-post">
											<div class="recent-post-img">
												<img src="images/resources/rp-img3.png" alt="">
											</div>
											<div class="recent-post-info">
												<span>26 September</span>
												<h3 class="post_title"><a href="blog_single_post_page.html" title="">Is Ductwork Cleaning Worth It?</a></h3>
											</div>
										</div><!--recent-post end-->
									</li>
								</ul><!--widget-posts end-->
							...
							<div class="widget widget-comments">
								...
								<ul class="cl-list">
									<li>
										<p><span>Jorge Moon</span> How often you run your system, the system’s age...</p>
									</li>
									<li>
										<p><span>Andrew Clair</span> We treat every customer like our very own family...</p>
									</li>
									<li>
										<p><span>Harriet Casella</span> Every company should strive for excellence...</p>
									</li>
								</ul><!--cl-list end-->
